...
function vraagGrootteMand() {
  rl.question("Hoe lang is de mand (3 - 20)? ", (antwoord) => {
    mandgroot = parseInt(antwoord, 10);
...
function vulGeschenkmand(i) {
  ...
  rl.question("Welk CADEAU kies je? (keuze: W, B, F): ", (keuze) => {
...
function berekenTotaal() {
  ...
  console.log(`de BTW is dit: €${totaalMetBTW.toFixed(2)}`);
